    ...
    \section{Lecture III}
        \subsection{ISA}
            ...
            \subsubsection{RISC vs. CISC (Complex/Reduced Instruction Set)}
                \begin{itemize}
                    \item Hot debate in the 80s
                    \item CISC (Complex Instruction Set Computer)
                    \item RISC (Reduce Instruction Set Computer)
                    \item Multiple comparisons (In Table 8)
                        \begin{table}[]
                            \centering
                            \begin{tabular}{cc}
CISC                                                                                                                & RISC                                                                                                                  \\ \hline
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Memory-to-Memory load/store \\ incorporated in instr.\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Register-to-Register Separate \\ load/store instructions\end{tabular}} \\ \hline
\multicolumn{1}{|c|}{HW difficult to implement}                                                                     & \multicolumn{1}{c|}{HW easy to implement}                                                                             \\ \hline
\multicolumn{1}{|c|}{Multi-cycle complex instructions}                                                              & \multicolumn{1}{c|}{Simple (single clock) instructions}                                                               \\ \hline
\multicolumn{1}{|c|}{Small code size}                                                                               & \multicolumn{1}{c|}{Large code size}                                                                                  \\ \hline
\multicolumn{1}{|c|}{High CPI}                                                                                      & \multicolumn{1}{c|}{Low CPI}                                                                                          \\ \hline
